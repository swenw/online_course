package com.example.school.service.sms.service.impl;
...
import com.example.school.service.sms.util.SmsProperties;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String checkCode) throws ClientException {
        ...
        if ("isv.BUSINESS_LIMIT_CONTROL".equals(code)) {
            ...
            throw new SchoolException(ResultCodeEnum.SMS_SEND_ERROR_BUSINESS_LIMIT_CONTROL);
        }

        if (!"OK".equals(code)) {
            log.error("短信发送失败 " + " - code: " + code + ", message: " + message);
            throw new SchoolException(ResultCodeEnum.SMS_SEND_ERROR);
        }
    }
}
